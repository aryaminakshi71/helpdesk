...
// ../../node_modules/.bun/better-auth@1.4.14+d8d708348641e738/node_modules/better-auth/dist/adapters/kysely-adapter/dialect.mjs
...
var createKyselyAdapter = async (config) => {
  ...
  if ("fileControl" in db) {
    const { BunSqliteDialect } = await import("./bun-sqlite-dialect-SY6K7VMR.js");
  ...
  if ("createSession" in db && typeof window === "undefined") {
    ...
    if (DatabaseSync && db instanceof DatabaseSync) {
      const { NodeSqliteDialect } = await import("./node-sqlite-dialect-K6TGD62Y.js");
...
//# sourceMappingURL=chunk-YBFXWHQR.js.map
