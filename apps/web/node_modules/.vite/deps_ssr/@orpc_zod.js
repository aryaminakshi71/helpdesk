import {
  Format
} from "./chunk-BLQ5MKQS.js";
import "./chunk-ZG5GZ3TY.js";
import "./chunk-EGHEV2Q4.js";
import "./chunk-T6L4O7FT.js";
import "./chunk-TU47NT6S.js";
...
// ../../node_modules/.bun/wildcard-match@5.1.4/node_modules/wildcard-match/build/index.es.mjs
...
function wildcardMatch(pattern, options) {
  ...
  var regexp2 = new RegExp("^".concat(regexpPattern, "$"), options.flags);
  var fn = isMatch.bind(null, regexp2);
  fn.options = options;
  fn.pattern = pattern;
  fn.regexp = regexp2;
  return fn;
...
// ../../node_modules/.bun/@orpc+json-schema@1.13.4+64f0629d09b745d9/node_modules/@orpc/json-schema/dist/index.mjs
var JsonSchemaXNativeType = ((JsonSchemaXNativeType2) => {
...
// ../../node_modules/.bun/@orpc+zod@1.13.4+7a103c883781e44a/node_modules/@orpc/zod/dist/index.mjs
var CUSTOM_JSON_SCHEMA_SYMBOL = /* @__PURE__ */ Symbol("ORPC_CUSTOM_JSON_SCHEMA");
var CUSTOM_JSON_SCHEMA_INPUT_SYMBOL = /* @__PURE__ */ Symbol("ORPC_CUSTOM_JSON_SCHEMA_INPUT");
var CUSTOM_JSON_SCHEMA_OUTPUT_SYMBOL = /* @__PURE__ */ Symbol("ORPC_CUSTOM_JSON_SCHEMA_OUTPUT");
...
function customJsonSchema(schema, custom2, options = {}) {
...
var CUSTOM_ZOD_DEF_SYMBOL = /* @__PURE__ */ Symbol("ORPC_CUSTOM_ZOD_DEF");
function setCustomZodDef(def, custom2) {
  Object.assign(def, { [CUSTOM_ZOD_DEF_SYMBOL]: custom2 });
}
...
function file(params) {
  ...
  return Object.assign(schema, {
    type: (mimeType, params2) => {
      const isMatch2 = wildcardMatch(mimeType);
      const refinedSchema = schema.refine(
        (val) => isMatch2(val.type.split(";")[0]),
        composeParams(
...
//# sourceMappingURL=@orpc_zod.js.map
